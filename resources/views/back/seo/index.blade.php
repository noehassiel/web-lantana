                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="page_theme_color_hex" name="page_theme_color_hex"
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Upload your text file with the proper configurations for robots.
                            We'll take care of the rest.</small>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" id="image" name="image" id="image" />
                                <small class="form-text text-muted">Imagen tiene que ser 180x180 (Cualquier tamaño diferente
                                    será modificado a 180x180).</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" id="image" name="image" id="image" />
                                <small class="form-text text-muted">Imagen tiene que ser 150x150 (Cualquier tamaño
                                    diferente será modificado a 150x150).</small>
                            </div>
                        </div>
                    </div>
                </div>
