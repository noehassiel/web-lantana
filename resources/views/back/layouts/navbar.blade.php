    ...
    <div class="collapse navbar-collapse px-4  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <a class="nav-link accordion-button"  type="button" data-bs-toggle="collapse" data-bs-target="#collapseContent" aria-expanded="true" aria-controls="collapseContent">
                  <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <i data-feather="image"></i>
                  </div>
                  <span class="nav-link-text ms-1">Contenido</span>
                </a>
              <div id="collapseContent" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <ul class="list-unstyled">
                    <li class="nav-item border-start my-0 pt-2">
                      <a class="nav-link position-relative ms-0 ps-2 py-2 {{ active_class(['admin/banners']) }}" href="{{ route('banners.index') }}">
                        <span class="nav-link-text ms-1">Banners</span>
                      </a>
                    </li>
                    <li class="nav-item border-start my-0 pt-2">
                      <a class="nav-link position-relative ms-0 ps-2 py-2 " href="{{ route('popups.index') }}">
                        <span class="nav-link-text ms-1">Pop-ups</span>
                      </a>
                    </li>
                  </ul>
                </div>
        ...
        <li class="nav-item">
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <a class="nav-link accordion-button"  type="button" data-bs-toggle="collapse" data-bs-target="#collapseMkt" aria-expanded="true" aria-controls="collapseMkt">
                  <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <i data-feather="globe"></i>
                  </div>
                  <span class="nav-link-text ms-1">Marketing</span>
                </a>
              <div id="collapseMkt" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <ul class="list-unstyled">
                    <li class="nav-item border-start my-0 pt-2">
                      <a class="nav-link position-relative ms-0 ps-2 py-2 {{ active_class(['admin/banners']) }}" href="{{ route('newsletter.index') }}">
        ...
        <li class="nav-item">
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <a class="nav-link accordion-button"  type="button" data-bs-toggle="collapse" data-bs-target="#collapseCatalog" aria-expanded="true" aria-controls="collapseCatalog">
                  <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <i data-feather="tag"></i>
                  </div>
                  <span class="nav-link-text ms-1">Catálogo</span>
                </a>
              <div id="collapseCatalog" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <ul class="list-unstyled">
                    <li class="nav-item border-start my-0 pt-2">
                      <a class="nav-link position-relative ms-0 ps-2 py-2 {{ active_class(['admin/banners']) }}" href="{{ route('products.index') }}">
                        <span class="nav-link-text ms-1">Productos</span>
                      </a>
                    </li>
                    <li class="nav-item border-start my-0 pt-2">
                      <a class="nav-link position-relative ms-0 ps-2 py-2 {{ active_class(['admin/banners']) }}" href="{{ route('categories.index') }}">
        ...
        <li class="nav-item">
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <a class="nav-link accordion-button"  type="button" data-bs-toggle="collapse" data-bs-target="#collapseCms" aria-expanded="true" aria-controls="collapseCms">
                  <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <i data-feather="bookmark"></i>
                  </div>
                  <span class="nav-link-text ms-1">CMS</span>
                </a>
              <div id="collapseCms" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <ul class="list-unstyled">
                    <li class="nav-item border-start my-0 pt-2">
                      <a class="nav-link position-relative ms-0 ps-2 py-2 {{ active_class(['admin/banners']) }}" href="{{ route('products.index') }}">
                        <span class="nav-link-text ms-1">Categorías de Blog</span>
                      </a>
                    </li>
                    <li class="nav-item border-start my-0 pt-2">
                      <a class="nav-link position-relative ms-0 ps-2 py-2 {{ active_class(['admin/banners']) }}" href="{{ route('categories.index') }}">
