...
@section('title')
    <div class="d-sm-flex align-items-center justify-content-between mg-lg-b-30">
        ...
        <div class="d-none d-md-block">
            <a href="javascript:void(0)" data-toggle="modal" data-target="#modalCreateLegalText"
                class="btn btn-sm btn-primary btn-uppercase"><i class="fas fa-plus"></i> Agregar Texto legal</a>
        </div>
    </div>
@endsection
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="priority">
                                            ...
                                            <option {{ $legal->priority == '1' ? 'selected' : '' }} value="1">1
                                            </option>
                                            <option {{ $legal->priority == '2' ? 'selected' : '' }} value="2">2
                                            </option>
                                            <option {{ $legal->priority == '3' ? 'selected' : '' }} value="3">3
                                            </option>
                                            <option {{ $legal->priority == '4' ? 'selected' : '' }} value="4">4
                                            </option>
                                            <option {{ $legal->priority == '5' ? 'selected' : '' }} value="5">5
                                            </option>
                                            <option {{ $legal->priority == '6' ? 'selected' : '' }} value="6">6
                                            </option>
                                            <option {{ $legal->priority == '7' ? 'selected' : '' }} value="7">7
                                            </option>
                                ...
                                <div class="d-flex justify-content-between">
                                    <button type="submit" class="btn btn-outline-success"><i class="far fa-save"></i>
                                        Guardar información</a></button>
                    </form>
                    <form method="POST" action="{{ route('legals.destroy', $legal->id) }}">
                        <button type="submit" class="btn btn-outline-danger btn-sm btn-icon" data-toggle="tooltip"
