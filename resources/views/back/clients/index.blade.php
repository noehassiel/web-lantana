    ...
    <div class="d-sm-flex align-items-center justify-content-between mg-lg-b-30">
        ...
        <div class="d-none d-flex align-items-center">
            ...
            <a href="javascript:void(0)" data-toggle="modal" data-target="#modalImport"
                class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5 mr-1">
                <i class="fas fa-file-import"></i> Importar
            </a>

            <a href="javascript:void(0)" data-toggle="modal" data-target="#modalCreate"
                class="btn btn-sm btn-primary btn-uppercase"><i class="fas fa-plus"></i> Agregar Cliente</a>
        </div>
    </div>
...
@section('content')
    @if ($clients->count() == 0)
        <div class="card card-body text-center" style="padding:80px 0px 100px 0px;">
            ...
            <p class="mb-4">En esta sección puedes administrar la información de tus clientes y ver su historial de
                compra.</p>

            <div class="d-flex align-items-center wd-300 justify-content-center ml-auto mr-auto">
                <a href="{{ route('clients.create') }}" data-toggle="modal" data-target="#modalCreate"
                    class="btn btn-sm btn-primary btn-uppercase">Agregar Cliente</a>
                <a href="javascript:void(0)" data-toggle="modal" data-target="#modalImport"
