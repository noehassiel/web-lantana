...
@section('content')
    @if ($popups->count() == 0)
        <div class="card card-body text-center" style="padding:80px 0px 100px 0px;">
            ...
            <a href="{{ route('popups.create') }}" class="btn btn-sm btn-primary btn-uppercase wd-200 ml-auto mr-auto"><i
                    data-feather="plus"></i> Crear nuevo Pop-up</a>
        </div>
    @else
        <div class="row">
            <div class="col-md-12">
                                ...
                                @foreach ($popups as $banner)
                                    <tr>
                                        <td style="width: 150px;">
                                            <img style="width: 100%;" src="{{ asset('img/popups/' . $banner->image) }}"
                                                alt="{{ $banner->title }}">
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('popups.show', $banner->id) }}"
                                                class="btn btn-link text-dark px-1 py-0">
                                                <i class="fas fa-eye" aria-hidden="true"></i>
                                            </a>

                                            <a href="{{ route('popups.edit', $banner->id) }}"
                                                class="btn btn-link text-dark px-1 py-0">
