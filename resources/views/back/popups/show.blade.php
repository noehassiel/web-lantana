...
@section('content')
    <div class="row mb-4">
        <div class="col-md-6 text-left">
            <a href="{{ route('popups.index') }}" class="btn btn-info mr-2"><i class="simple-icon-arrow-left"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col">
                                    <h5>Imagen</h5>
                                    <div class="card">
                                        <p class="badge badge-primary">Identificador de base de datos: {{ $popup->id }}
                                        </p>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <div class="card-banner d-flex justify-content-center align-items-center" id="hex_"
                            ...
                            <img src="{{ asset('img/popups/' . $popup->image) }}" id="output" class="card-banner-image"
                                width="100">
                        </div>
                    </div>
                </div>
