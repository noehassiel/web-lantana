                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" checked="true" class="custom-control-input" id="show_on_enter"
                                        name="show_on_enter" value="1">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="show_on_exit"
                                        name="show_on_exit" value="1">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox mb-3">
                                    <input type="checkbox" class="custom-control-input" id="has_button" name="has_button"
                                        value="1">
                            ...
                            <div id="selector" class="form-group col-md-12 hidden-form">
                                ...
                                <div class="row selector" name="priority">
                                    ...
                                    <div class="col-md-4">
                                        <input type="radio" class="cube" name="position" value="bottom-left">
                                        </input>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="radio" class="cube" name="position" value="bottom-mid">
                                        </input>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="radio" class="cube" name="position" value="bottom-right">
                                        </input>
                                    </div>
