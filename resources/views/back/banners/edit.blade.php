                        ...
                        <div class="row">
                            <div class="form-group col-md-8">
                                ...
                                <select class="form-control" name="is_promotional" required>
                                    <option value="0" {{ $banner->is_promotional == '0' ? 'selected' : '' }}>
                                        Principal</option>
                                    <option value="1" {{ $banner->is_promotional == '1' ? 'selected' : '' }}>
                                        Promocional</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                @if ($banner->image != null)
                                    <img style="width: 100%;" src="{{ asset('img/banners/' . $banner->image) }}"
                                        alt="{{ $banner->title }}">
                                @endif

                                @if ($banner->video_background != null)
                                    <iframe width="100%" height="300"
                                        src="https://www.youtube.com/embed/{{ $banner->video_background }}?controls=0&autoplay=1&mute=1&modestbranding=1&showinfo=0"
                                        title="{{ $banner->title }}" frameborder="0"
