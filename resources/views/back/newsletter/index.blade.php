...
@section('content')
    @if ($newsletter->count() == 0)
        <div class="card card-body text-center" style="padding:80px 0px 100px 0px;">
            ...
            <p class="mb-4">En esta sección puedes administrar la información de tus clientes registrados para newsletter.
            </p>
        </div>
    @else
        <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-muted"><i class="far fa-clock"></i>
                                                {{ Carbon\Carbon::parse($new->created_at)->format('d M Y - H:i') }}</span>
                                        </td>

                                        <td>
                                            <a href="javascript:void(0)" data-toggle="modal"
                                                data-target="#modalEdit{{ $new->id }}"
                                                class="btn btn-outline-primary btn-sm btn-icon">
                                                <i class="fas fa-edit" aria-hidden="true"></i>
                                            </a>
                                            <form method="POST" action="{{ route('newsletter.destroy', $new->id) }}"
                                        ...
                                        <div class="modal-dialog modal-dialog-vertical-center" role="document">
                                            <div class="modal-content bd-0 tx-14">
                                                <div class="modal-header">
                                                    <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Editar registro
                                                        de newsletter</h6>
                                                ...
                                                <form method="POST" action="{{ route('newsletter.update', $new->id) }}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name"
                                                                        class="form-control" value="{{ $new->name }}">
                                                                </div>
                                                            </div>

                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="e_mail">Correo <span
                                                                            class="tx-danger">*</span></label>
                                                                    <input type="text" name="email"
                                                                        class="form-control" value="{{ $new->email }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
